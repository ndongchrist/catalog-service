...
if env.bool("USE_SQLITE", False):
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env.str("POSTGRES_DB", "catalog"),
            "USER": env.str("POSTGRES_USER", "catalog"),
            "PASSWORD": env.str("POSTGRES_PASSWORD", "catalog"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "catalog.auth.GatewayUserAuthentication",
    ],
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "A Django REST Framework microservice",
    "VERSION": "0.1.0",
